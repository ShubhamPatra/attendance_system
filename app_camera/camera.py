...
from app_vision.overlay import draw_track_overlay
from app_core.performance import tracker
from app_vision.pipeline import FaceTrack, centroid_distance, detect_and_associate_detailed, detect_motion, iou
...
def _face_engine_module():
    ...
    if _lazy_face_engine is None:
        import app_vision.face_engine as _mod
...
def _recognition_module():
    ...
    if _lazy_recognition is None:
        import app_vision.recognition as _mod
...
def _anti_spoofing_module():
    ...
    if _lazy_anti_spoofing is None:
        import app_vision.anti_spoofing as _mod
...
def _ppe_detection_module():
    ...
    if _lazy_ppe_detection is None:
        import app_vision.ppe_detection as _mod
